...
alias Update="sudo mv /usr/share/applications/ /usr/share/applications_ ; paru -Syyu ; sudo mv /usr/share/applications_ /usr/share/applications"
...
then
	clear ; neofetch
elif [ $(pgrep alacritty | wc -l) -le 2 ];
then
	if [ ! $(pgrep tilix | wc -l) ];
	then
		neofetch
